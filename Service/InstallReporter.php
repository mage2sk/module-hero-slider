<?php
/**
 * Standalone install + heartbeat reporter for Panth_HeroSlider.
 *
...
namespace Panth\HeroSlider\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_HeroSlider';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-hero-slider';
